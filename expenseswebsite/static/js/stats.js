...
const renderChartBar = (data, labels, month) => {
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [
        {
          label: (mon?"Lifetime Expenses":`Last ${month} Months Expenses`),
          data: data,
...
function getLocalStorage(){
  document.getElementById("pastExpenseData").value = localStorage.getItem("period");
  document.getElementById("diagram").value = localStorage.getItem("diagram");
}

function handleSelectChange() {
  let selectedOption = document.getElementById("pastExpenseData").value;
  ...
  fetch(url)
    ...
    .then((results) => {
      ...
      localStorage.setItem("period",selectedOption)
      localStorage.setItem("diagram",selectedDiagramOption)
    });
}
